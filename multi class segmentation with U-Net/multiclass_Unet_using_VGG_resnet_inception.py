...
model1.save('res34_backbone_5epochs.hdf5')
############################################################
###Model 2
...
model2.save('inceptionv3_backbone_5epochs.hdf5')
...
model3.save('vgg19_backbone_5epochs.hdf5')
...
model1 = load_model('saved_models/res34_backbone_5epochs.hdf5', compile=False)
model2 = load_model('saved_models/inceptionv3_backbone_5epochs.hdf5', compile=False)
model3 = load_model('saved_models/vgg19_backbone_5epochs.hdf5', compile=False)
